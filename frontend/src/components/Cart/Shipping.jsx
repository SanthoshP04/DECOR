                ...
                <Container className="my-5">
                    <Row>
                        <Col lg={8} className="mb-5 mb-lg-0 pe-md-5">
                            <h1 className="fw-bold font-22 text-blue-500-color mb-4">Checkout</h1>
                            <Form className="bg-gray-300-color px-4 py-5" onSubmit={handleSubmit}>
                                ...
                                <Button 
                                    as={Link} 
                                    to="/products" 
                                    className="bg-secondary-color border-0 my-2 py-2 px-3 rounded-0 text-white"
                                >
                                    Continue Shopping
                                </Button>
                            </Form>
