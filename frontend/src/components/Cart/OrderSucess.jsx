    ...
    return (
        <>
            ...
            <Stack className="order-success justify-content-center align-items-center h-100vh">
                ...
                <h1 className="text-primary-color text-center font-35 fw-bold my-3">
                    Your Order Is Completed!
                </h1>
                
                <p className="text-gray-100-color font-lato fw-semibold text-center mb-5">
                ...
                <Button 
                    as={Link} 
                    to="/products" 
                    className="font-lato fw-semibold bg-secondary-color border-0 rounded-0 p-4 mb-2 d-flex align-items-center justify-content-center"
