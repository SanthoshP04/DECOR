                        ...
                        <Form noValidate onSubmit={handleSubmit} className="mt-5">
                            ...
                            <Form.Group controlId="password">
                                <Form.Control 
                                    ...
                                    className="font-lato font-16 mb-2" 
                                    onChange={handleChange} 
                                    onBlur={handleBlur} 
                                ...
                                <Link to="/password/forgot" className="text-decoration-none text-gray-500-color font-lato font-17">
                            ...
                            <p className="text-center text-gray-500-color font-lato font-17 m-0">
                                Don't have an Account?&nbsp;
                                <Link to="/register" className="text-decoration-none text-gray-500-color">
                                    Create account
                                </Link>
                            </p>
                        </Form>
