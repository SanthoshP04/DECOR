...
const Signup = () => {
    ...
    const { loading, success, error, message, headerLoading } = useSelector(
        (state) => state.user
    );

    const [checkAuthentication, setCheckAuthentication] = useState(false);
    const [avatarPreview, setAvatarPreview] = useState("https://res.cloudinary.com/dodtenm9q/image/upload/v1692464431/c2gxwg2zskvdmgpfm6gb.webp");
    ...
    const handleAvatarChange = (e) => {
        ...
        reader.onload = () => {
            if (reader.readyState === 2) {
                setFieldValue('avatar', reader.result); // base64 string
            ...
            <div className="users-page my-5 py-5">
                <Container>
                    <Card className="p-3 p-md-5 border-0 card-shadow">
                        ...
                        <span className="text-center text-gray-500-color font-lato font-17">
                            Join Hekto today for exciting offers.
                        </span>
                        <Form onSubmit={handleSubmit} className="mt-5">
                            ...
                            <Form.Group className="mb-4" controlId="avatar">
                                ...
                                <span className="text-gray-500-color font-lato font-15">
                            ...
                            <Button
                                ...
                                className="w-100 my-4 bg-secondary-color border-0 rounded-1"
