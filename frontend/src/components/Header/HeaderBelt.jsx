    ...
    return (
        <>
            ...
            <Navbar className="header-belt bg-white" expand="md" variant="dark" sticky="top">
                <Container>
                    <Navbar.Brand as={Link} to="/" className="fs-2 fw-semibold text-primary-color">
                        Zoro
                    </Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarScroll" />
                    <Navbar.Collapse id="navbarScroll" className="py-2 py-md-0">
                        <Nav className="me-auto ms-0 ms-lg-5 my-2 my-lg-0 font-16 font-lato">
                            <Nav.Link active={location.pathname === "/"} as={Link} to="/" className="px-3">
                                Home
                            </Nav.Link>
                            <Nav.Link active={location.pathname.includes("/product")} as={Link} to="/products" className="px-3">
                                Products
                            </Nav.Link>
                            <Nav.Link active={location.pathname.includes("/blogs")} as={Link} to="/blogs" className="px-3">
                                Blogs
                            </Nav.Link>
                            <Nav.Link active={location.pathname.includes("/contact")} as={Link} to="/contact" className="px-3">
                                Contact
                            </Nav.Link>
                        ...
                        <Form className="d-flex" onSubmit={searchSubmitHandler}>
                            ...
                            />
                            <Button 
                                className="bg-secondary-color border-0 outline-0 rounded-0" 
                                type="submit"
                                aria-label="Search"
                            >
