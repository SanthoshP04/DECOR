            ...
            <Nav variant="tabs" className="home-products-tab justify-content-center flex-column flex-md-row border-0 mb-5">
                {tabs.map((tab) => (
                    <Nav.Item key={tab.tab}>
                        <Nav.Link 
                            eventKey={tab.tab} 
                            className="border-0 font-lato text-center my-2 mx-0 mx-md-3"
                        >
                            {tab.productName}
                        </Nav.Link>
                    </Nav.Item>
                    ...
                    <Tab.Pane key={item.tab} eventKey={item.tab}>
                        <Row className="justify-content-center">
                            <Col md="6" className="mb-4 mb-md-0">
                                <h2 className="text-primary-color fw-bold font-35 mb-3">
                                    20% Discount Off on {item.productName}
                                </h2>
                                <p className="text-gray-100-color font-lato font-17">
                                ...
                                <Row className="text-gray-100-color font-lato font-17 discount-products-list">
                                    ...
                                    <Col md={6} className="mb-3 discount-products-list-items">Clear lines and geometric figures</Col>
                                ...
                                <Button 
                                    as={Link} 
                                    to="/products" 
                                    className="bg-secondary-color border-0 rounded-0 fw-semibold d-flex align-items-center justify-content-center mt-4"
