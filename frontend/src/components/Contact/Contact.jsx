...
const Contact = () => {
    ...
    return (
        <>
            ...
            {contactAlert && <HeaderAlert message={contactAlert} />}

            <Container>
                <h1 className="font-22 text-primary-color fw-bold my-5">Contact Us</h1>
                <hr />
                ...
                <Row xs={1} lg={2} className="my-5 justify-content-center g-4">
                    <Col className="mb-4 mb-md-0">
                        ...
                        <p className="font-lato text-gray-100-color mb-4">
                        ...
                        <Stack direction="horizontal" className="contact-info-circles" gap={2}>
                            <div className="bg-primary-color rounded-circle" aria-hidden="true"></div>
                            <div className="bg-secondary-color rounded-circle" aria-hidden="true"></div>
                            <div className="bg-green-100-color rounded-circle" aria-hidden="true"></div>
                        </Stack>
                    </Col>
                    ...
                    <Col>
                        ...
                        <Stack gap={4} className="flex-column flex-md-row mb-4">
                            <Stack direction="horizontal" className="contact-way" gap={3}>
                                <Stack>
                ...
                <Row xs={1} lg={2} className="my-5 py-5 justify-content-center g-4">
                    <Col className="mb-4 mb-md-0">
                        ...
                        <Form onSubmit={registerSubmit} className="mt-5">
                            ...
                            <Button 
                                type="submit" 
                                className="bg-secondary-color border-0 rounded-0 fw-semibold"
